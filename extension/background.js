...
//  Сборка puppeteer (pptr_build) и бандл удалены — расширение работает на DOM-снапшоте
//  через chrome.scripting; если понадобится, puppeteer восстанавливается из старой git-истории.
//  Расширение снова лёгкое и быстрое — музыка/видео/поиск работают как раньше.)
