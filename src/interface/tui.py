...
def _banner(phase: int = 0) -> Table:
    ...
    try:
        ...
        from src.llm.llm import active_summary
...
class SeaTUI(App):
    ...
    async def _command(self, raw: str) -> None:
        ...
        if cmd in ("/help", "/?"):
            ...
            from src.runtime.sea_workspace import init
            created = init()
            ...
            from src.graph.agent import rebuild_llms
            ...
            from src.config.cli_config import get_cli
            from src.llm.llm import active_summary, api_key_source
            self._log("\n[bold #38c6ff]config[/]\n"
            ...
            from src.graph.agent import memory_store
            ...
            from src.llm.usage import cost_of
            ...
            from src.browser import browser_bridge as _bb
    ...
    def _ask(self, query: str) -> None:
        ...
        from src.llm.usage import TokenTracker
    ...
    def _attach_file(self, path: str) -> None:
        ...
        from src.data.knowledge_base import add_session_file
        try:
    ...
    def _kb_add(self, path: str) -> None:
        ...
        from src.data.knowledge_base import add_document
        try:
    ...
    def _kb_find(self, query: str) -> None:
        from src.data.knowledge_base import search_kb
        try:
    ...
    def _kb_ls(self) -> None:
        from pathlib import Path as _P
        try:
            from src.data.knowledge_base import _user_root
    ...
    async def _do_init_overview(self) -> None:
        ...
        from src.graph.agent import llm
        from src.runtime.sea_workspace import build_overview_messages, gather_repo_digest
